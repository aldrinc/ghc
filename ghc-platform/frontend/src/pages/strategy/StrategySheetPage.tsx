...
export function StrategySheetPage() {
  ...
  const planningWorkflow = useMemo(
    () =>
      workflows
        .filter((wf) => wf.client_id === workspace?.id && wf.kind === "campaign_planning")
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        description="Goal, hypothesis, channel plan, and messaging for this workspace."
        actions={
          strategyArtifact ? (
            <Button
              variant="primary"
        ...
        {strategyArtifact ? (
          <div className="text-xs text-content-muted">
            {workflowsLoading
              ...
              : "Approving sends a signal to generate experiments from this strategy sheet."}
          </div>
        ) : null}
      </PageHeader>
