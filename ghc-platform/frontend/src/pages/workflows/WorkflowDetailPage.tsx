  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        description="Inspect research artifacts and send approvals to unblock downstream steps."
      />
            ...
            <div className="rounded-lg border border-border bg-surface shadow-sm">
              <div className="flex items-center justify-between border-b border-border px-4 py-3">
                <div>
                  ...
                  <div className="text-xs text-content-muted">Generated from the approved strategy.</div>
                </div>
              </div>
            ...
            <div className="rounded-lg border border-border bg-surface shadow-sm">
              <div className="flex items-center justify-between border-b border-border px-4 py-3">
                <div>
                  ...
                  <div className="text-xs text-content-muted">Derived from experiment variants.</div>
                </div>
              </div>
              <div className="space-y-3 p-4 text-sm">
                    ...
                    return (
                      <div key={brief.id} className="rounded border border-border bg-white/60 p-3">
                        ...
                        <div className="mt-1 text-xs text-content-muted">
                          Experiment: {brief.experimentId || "—"} · Requirements: {requirements.length}
                        </div>
                        {requirements.length ? (
                          <div className="mt-2 text-xs text-content-muted">
                    ...
                    <div className="grid gap-2 md:grid-cols-2">
                      {messaging.map((m, idx) => (
                        <div key={idx} className="rounded border border-border bg-white/60 p-3">
                          ...
                          <div className="mt-1 text-xs text-content-muted">
                            Segments: {(m.targetSegments || []).join("; ") || "—"}
                          </div>
                        </div>
                      ))}
                    </div>
