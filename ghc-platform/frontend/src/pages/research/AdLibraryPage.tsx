...
export function AdLibraryPage() {
  ...
  useEffect(() => {
    ...
    setApiLoading(true);
    listAds({ clientId: workspace.id, limit: 200 })
      .then((resp) => {
        if (cancelled) return;
  ...
  return (
    <div className="space-y-4">
      <PageHeader title="Ad Library" description="Ads ingested during onboarding, plus saved swipes for this workspace." />
