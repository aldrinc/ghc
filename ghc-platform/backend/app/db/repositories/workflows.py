...
class WorkflowsRepository:
    ...
    def list(self, org_id: str, client_id: str | None = None, campaign_id: str | None = None) -> List[WorkflowRun]:
    ...
    def has_onboarding_approvals(self, org_id: str, client_id: str) -> bool:
        stmt = (
