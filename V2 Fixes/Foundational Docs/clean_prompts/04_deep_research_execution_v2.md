...
- **Aspirational identity:** Who do they want to BECOME as a result of solving this? What would they call themselves? Find quotes that reveal identity aspirations.
- **Rejected identity:** Who do they absolutely REFUSE to be associated with? What labels make them recoil? Find quotes showing identity boundaries.
...
### Category B: Purchase Triggers & Decision Journey

Find the specific events, moments, or breaking points that cause people to actively seek a solution NOW rather than later.
...
- Prejudices and stereotypes within this niche
...
This distinction is essential. Downstream copy must validate the legitimate concern without amplifying the distortion.

---

### Category F: Decision Friction & Purchase Barriers
...
**For each major solution category the market uses:**

- What does the market **LIKE** about this category?
- What does the market **DISLIKE**?
...
- **HIGH SIGNAL (5+ independent sources):** Reliable market pattern. Mark as foundational input for downstream prompts.
- **MODERATE SIGNAL (2-4 sources):** Consistent pattern but could reflect sampling bias. Mark as strong hypothesis.
- **LOW SIGNAL (1 source):** Anecdotal. Flag as "anecdotal — requires validation."
...
- **HIGH CONFIDENCE:** Strong convergence across diverse sources with minimal contradiction. Treat as established fact for downstream use.
- **MODERATE CONFIDENCE:** Multiple sources, consistent pattern, but could be sampling bias. Treat as strong working hypothesis.
...
This bottleneck finding is the single most important output of this research. Everything downstream should be stress-tested against it.
