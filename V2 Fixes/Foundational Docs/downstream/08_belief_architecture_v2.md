...
### Phase 2: Belief Dependency Mapping

Arrange ALL discovered beliefs into a dependency graph. Some beliefs are PREREQUISITES for others.
...
How hard is it to shift this belief with marketing alone?
...
**Note on inversion:** We invert Current Belief State because beliefs that are ALREADY strongly held don't need priority. Beliefs NOT YET held need the most attention.
...
**Flag UNIVERSAL beliefs** — HIGH priority across ALL segments. Must appear in every piece of creative.

**Flag SEGMENT-SPECIFIC beliefs** — HIGH for one segment but LOW for others. Drive segment-specific ad variations.

---

### Phase 5: Proof Architecture

For each belief in the top 50% by Conversion Priority Score, map the optimal proof strategy.

**Proof type selection principle:** Choose the proof type that carries the MOST information for the LEAST attention cost.
...
|---|---|---|---|
| **Social proof** | "It works for people like me" | HIGH | Specific outcome testimonial with detail |
| **Authority proof** | "This source is trustworthy" | MODERATE | Named expert review or endorsement |
| **Demonstration proof** | "The quality is real" | VERY HIGH | Sample pages, video walkthrough, free chapter |
| **Logical proof** | "It's worth the price" | HIGH for System 2 buyers | Cost comparison calculation |
| **Risk reversal** | "I won't get burned" | HIGH | Specific guarantee terms + refund language |
| **Process proof** | "This was made with care" | MODERATE | Research methodology, sourcing, editorial process |
...
**Gap check:** Are there any Tier 1 objections with NO corresponding belief? If yes, add the missing belief and score it.

---

### Phase 7: Engineering Safety Factor Audit

**1. Unresolved Tier 1 check:** Any Tier 1 objection with NO strong rebuttal or proof? Flag as **UNRESOLVED RISK.**

**2. Proof gap check:** Any top-5 belief with Proof Availability = 1 or 2? Flag as **ASPIRATIONAL, NOT ACHIEVABLE** with existing proof. Recommend what proof to create.

**3. Dependency chain integrity:** Walk Level 1 → Level 5. Any broken links? Add missing beliefs.

**4. Contradiction check:** Any beliefs that CONTRADICT each other? Note the tension and specify how copy should handle it.
...
Produce 5-8 belief statements. Each must:

1. **Target a TOP-RANKED belief** from Phase 3
2. **Be written in customer voice** — VOC language, not marketer abstraction
...
5. **Specify the target segment** (or "universal")

Format:
```
STATEMENT: "I believe that [statement in customer voice]"
TARGET BELIEF: [which belief from Phase 3 — include rank]
...
Write the core promise in 2-3 sentences using ONLY language patterns found in VOC research. This is the promise as the CUSTOMER would articulate it.

### Closing Belief Chain Summary

Write a 3-5 sentence narrative that ties together WHY this product works for the primary segment NOW:
- Open with the world belief (foundational context)
...
This summary is the "pitch in a paragraph" for email sequences, ad copy, and sales page conclusions.
...
"[rebuttal copy]"
PROOF ELEMENT: [what proof should accompany this]
PLACEMENT: [where in funnel]
```
...
<CONTENT>
LAYER 1: Full belief architecture — Phase 1 through Phase 7.
