...
Assess where this product category sits in its lifecycle:

| Stage | Characteristics | Marketing Implication |
|---|---|---|
| **Introduction** | Market doesn't know this category exists | Lead with PROBLEM education |
| **Growth** | Market aware, competition increasing | Lead with DIFFERENTIATION |
| **Maturity** | Market saturated, buyers sophisticated | Lead with MECHANISM |
| **Decline** | Market fatiguing, switching to new solution types | Lead with REINVENTION |
...
|---|---|---|
| **Unaware** | Doesn't know they have a problem | Lead with story/disruption |
| **Problem-Aware** | Knows the problem, doesn't know solutions exist | Lead with the problem, agitate, introduce solution |
| **Solution-Aware** | Knows solutions exist, doesn't know YOUR product | Lead with unique mechanism and differentiation |
...
1. **First** — Simple direct claim works
2. **Second** — Need to enlarge the claim
3. **Third** — Need mechanism
4. **Fourth** — Need to elaborate mechanism
5. **Fifth** — Need identification
...
**Constraint: The 3 candidates must be meaningfully different.** If two candidates are minor variations, collapse them and generate a truly different third.

---

## Phase 3: Candidate Evaluation (TOOL-ASSISTED SCORING)

**CRITICAL: Use your code interpreter / calculator tool for ALL scoring computations. Do NOT estimate scores mentally.**
...
How many competitors already use this positioning?
...
- Dominant market angle, heavily saturated = 1

### Dimension 3: Emotional Resonance (Weight: 0.20)
How intense is the emotional response this triggers in the primary segment?
- Taps into HIGH-intensity fears AND aspirations = 5
- HIGH-intensity on one dimension = 4
- MODERATE-intensity emotions = 3
- LOW-intensity emotions = 2
- Emotionally flat = 1

### Dimension 4: Mechanism Credibility (Weight: 0.15)
How believable is the "why it works" story?
- Factually accurate, easily demonstrated, intuitive = 5
- Accurate but requires some explanation = 4
- Plausible but not directly provable = 3
- Requires significant suspension of disbelief = 2
- Essentially fabricated marketing language = 1

### Dimension 5: Compliance Safety (Weight: 0.10)
Can this be marketed without regulatory risk?
- No claims that could trigger regulatory concern = 5
- Minor structure claims, well-supported = 4
- Some claims require careful wording = 3
- Borderline claims = 2
- Would likely face regulatory action = 1

### Dimension 6: Creative Scalability (Weight: 0.10)
Can this positioning sustain 6-12 months of creative before fatiguing?
...
Expand the discovery story kernel into a 3-5 sentence narrative that:
- Feels authentic and specific
- Creates a "guru" figure or discovery moment that builds authority
- Naturally leads into the mechanism explanation
...
|---|---|---|---|
| [belief] | Already believed / Partially / Actively disbelieved | [VOC cite] | [Low/Moderate/High effort] |
...
### Post-Purchase Beliefs (must remain true to prevent refund)
...
## Phase 7: Value Quantification Framework
...
## Phase 8: Funnel Architecture with Momentum Mapping

| Step | Entry State | Action Required | Exit State | Momentum Mechanism | Friction Points |
|---|---|---|---|---|---|
| Ad | [emotion/belief arriving] | Click | [emotion/belief leaving] | [what creates forward force] | [what could stop them] |
| LP - Above Fold | [from ad click] | Continue reading | [hooked, curious] | [headline + subhead + hero] | [slow load, wrong audience] |
| LP - Body | [curious, partially believing] | Continue to CTA | [convinced, trusting] | [mechanism + proof + objections] | [too long, missing proof] |
| Checkout | [convinced, ready] | Complete purchase | [confident] | [price anchor + guarantee + urgency] | [unexpected costs, weak guarantee] |
| Post-Purchase | [hopeful, slightly anxious] | Use product, don't refund | [satisfied, validated] | [welcome sequence + quick win] | [buyer's remorse, complexity] |
...
If you cannot identify a mitigation for a failure mode, FLAG it as **UNRESOLVED RISK**.
...
| UMP/UMS | Semi-fixed | Core mechanism stays, emphasis shifts per segment |
| Headline / Hook | Variable | Changes per angle, segment, and platform |
| Proof emphasis | Variable | Some segments need authority proof, others social proof |
| Emotional trajectory | Variable | Some segments respond to fear → relief, others confusion → clarity |
| Discovery story | Semi-fixed | Core story stays, emphasized details change |

This map tells downstream copy agents what can be adapted per angle vs. what must remain consistent.
