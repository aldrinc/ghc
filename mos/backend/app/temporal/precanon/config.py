...
RESEARCH_STEP_KEYS: List[str] = ["01", "015", "03", "04", "06", "07", "08", "09"]
...
STEP_DEFINITIONS: Dict[str, StepDefinition] = {
    "01": StepDefinition(
        ...
        title="Competitor Research (Web)",
        summary_max_chars=1200,
    ),
    "015": StepDefinition(
        key="015",
        prompt_filename="01.5_purple_ocean_analyst.md",
        title="Purple Ocean Angle Analysis",
