...
class WorkflowKindEnum(str, Enum):
    ...
    swipe_animated_template_analysis = "swipe_animated_template_analysis"
    swipe_animated_template_render = "swipe_animated_template_render"
