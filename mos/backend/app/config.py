...
class Settings(BaseSettings):
    ...
    DEPLOY_TRACKING_VALIDATION_REQUIRE_POSTHOG_READBACK: bool = False
    ...
    DEPLOY_HTML_DEPLOY_LIGHTHOUSE_ENABLED: bool = True
    DEPLOY_HTML_DEPLOY_LIGHTHOUSE_COMMAND: str = "lighthouse"
    DEPLOY_HTML_DEPLOY_LIGHTHOUSE_TIMEOUT_SECONDS: float = 180.0
    DEPLOY_HTML_DEPLOY_LIGHTHOUSE_MOBILE_MIN_SCORE: float = 85.0
    DEPLOY_HTML_DEPLOY_LIGHTHOUSE_DESKTOP_MIN_SCORE: float = 85.0
    ...
    META_GRAPH_MAX_CONCURRENT_READS_PER_ACCOUNT: int = 2
    META_GRAPH_READ_SLOT_WAIT_TIMEOUT_SECONDS: float = 5.0
    META_GRAPH_RATE_LIMIT_MAX_RETRIES: int = 2
    META_GRAPH_RATE_LIMIT_BASE_DELAY_SECONDS: float = 2.0
    META_GRAPH_RATE_LIMIT_MAX_DELAY_SECONDS: float = 15.0
