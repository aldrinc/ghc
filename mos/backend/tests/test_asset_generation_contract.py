...
def test_normalize_requirement_format_aliases() -> None:
    ...
    assert _normalize_requirement_format("gif") == "animated_image"
    assert _normalize_requirement_format("animated") == "animated_image"
    assert _normalize_requirement_format("animated-image") == "animated_image"
