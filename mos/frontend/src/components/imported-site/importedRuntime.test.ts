...
describe("buildImportedRuntimeSrcDoc", () => {
  ...
  it("binds icon-only navigation buttons by aria-label without replacing their contents", () => {
    const reactStubSource = `
      var React = window.React = {
        Fragment: Symbol.for("react.fragment"),
        createElement(type, props, ...children) {
  ...
  it("preserves the original offer title when copy overrides rewrite the selected tier heading", () => {
    const reactStubSource = `
      var React = window.React = {
        Fragment: Symbol.for("react.fragment"),
        createElement(type, props, ...children) {
  ...
  it("hydrates imported purchase cards with live runtime variant pricing", () => {
    const reactStubSource = `
      var React = window.React = {
        Fragment: Symbol.for("react.fragment"),
        createElement(type, props, ...children) {
