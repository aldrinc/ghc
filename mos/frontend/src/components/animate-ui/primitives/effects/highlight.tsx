...
function HighlightInner<T extends React.ElementType = 'div'>(
...
const Highlight = React.forwardRef(HighlightInner) as <T extends React.ElementType = 'div'>(
  props: HighlightProps<T> & { ref?: React.Ref<HTMLDivElement> },
...
function HighlightItemInner<T extends React.ElementType>(
  {
    as,
    children,
    id,
...
const HighlightItem = React.forwardRef(HighlightItemInner) as <
  T extends React.ElementType = 'div',
>(
  props: HighlightItemProps<T> & { ref?: React.Ref<HTMLDivElement> },
) => React.ReactElement | null;
