...
function DropdownMenuContent({
  ...
  return (
    <DropdownMenuContentPrimitive
      ...
      className={cn(
        'bg-popover text-popover-foreground z-50 max-h-[var(--radix-dropdown-menu-content-available-height)] min-w-[8rem] origin-[var(--radix-dropdown-menu-content-transform-origin)] overflow-x-hidden overflow-y-auto rounded-md border border-border p-1 shadow-md outline-none',
        className,
      )}
      {...props}
    >
      <DropdownMenuHighlightPrimitive
        ...
        className="absolute inset-0 z-0 rounded-sm bg-hover"
      >
        {children}
      </DropdownMenuHighlightPrimitive>
    </DropdownMenuContentPrimitive>
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuHighlightItemPrimitive
      activeClassName={
        variant === 'destructive' ? 'bg-danger/10' : ''
      }
      disabled={disabled}
    >
      <DropdownMenuItemPrimitive
        ...
        className={cn(
          "focus:bg-hover focus:text-content focus-visible:outline-none focus-visible:ring-0 focus-visible:shadow-none data-[highlighted]:bg-hover data-[variant=destructive]:text-danger data-[variant=destructive]:focus:text-danger [&_svg:not([class*='text-'])]:text-content-muted relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none select-none transition-colors duration-[var(--dur-fast)] ease-[var(--ease-out)] data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
          className,
        )}
        {...props}
      />
  ...
  return (
    <DropdownMenuHighlightItemPrimitive disabled={disabled}>
      <DropdownMenuCheckboxItemPrimitive
        disabled={disabled}
        className={cn(
          "focus:bg-hover focus:text-content focus-visible:outline-none focus-visible:ring-0 focus-visible:shadow-none data-[highlighted]:bg-hover relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-none select-none transition-colors duration-[var(--dur-fast)] ease-[var(--ease-out)] data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
          className,
        )}
        checked={checked}
        {...props}
...
function DropdownMenuShortcut({
  ...
  return (
    <DropdownMenuShortcutPrimitive
      className={cn(
        'text-content-muted ml-auto text-xs tracking-widest',
        className,
      )}
      {...props}
    />
  ...
  return (
    <DropdownMenuHighlightItemPrimitive disabled={disabled}>
      <DropdownMenuSubTriggerPrimitive
        ...
        data-inset={inset}
        className={cn(
          'focus:bg-hover focus:text-content focus-visible:outline-none focus-visible:ring-0 focus-visible:shadow-none data-[highlighted]:bg-hover data-[state=open]:bg-hover data-[state=open]:text-content flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-none select-none transition-colors duration-[var(--dur-fast)] ease-[var(--ease-out)] data-[inset]:pl-8',
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuSubContentPrimitive
      className={cn(
        'bg-popover text-popover-foreground z-50 min-w-[8rem] origin-[var(--radix-dropdown-menu-content-transform-origin)] overflow-hidden rounded-md border border-border p-1 shadow-lg outline-none',
        className,
      )}
      {...props}
    />
