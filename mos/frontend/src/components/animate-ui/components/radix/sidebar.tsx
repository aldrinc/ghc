...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground opacity-70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-300 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-foreground absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
  ...
  'bg-sidebar-accent text-sidebar-foreground rounded-md',
  {
    variants: {
      variant: {
        ...
        outline:
          'bg-sidebar-accent text-sidebar-foreground shadow-[0_0_0_1px_var(--sidebar-accent)]',
      },
    },
    defaultVariants: {
      variant: 'default',
...
function SidebarMenuSubButton({
  ...
  return (
    <HighlightItem activeClassName="bg-sidebar-accent text-sidebar-foreground rounded-md">
      <Comp
