...
DEFAULT_BLUEPRINT_VALIDATION_MAX_ATTEMPTS = int(
    os.environ.get("DEFAULT_BLUEPRINT_VALIDATION_MAX_ATTEMPTS", "10")
)
BLUEPRINT_VALIDATED_LOOP_PASS_SCORE = float(
    os.environ.get("BLUEPRINT_VALIDATED_LOOP_PASS_SCORE", "0.98")
)
